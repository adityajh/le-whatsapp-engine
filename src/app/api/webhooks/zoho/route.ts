...
export async function POST(req: NextRequest) {
  try {
    ...
    const contactFields = {
      ...
      lead_source: data.lead_source || data['Lead Source'] || null,
      campaign_name: data.campaign_name || data['Ad Campaign Name'] || null,
      owner_email: data.owner_email || null,
      program: data.program || data.Program || null,
      persona: data.persona || data.You_are_interested_as1 || data.You_are_interested_as || null,
